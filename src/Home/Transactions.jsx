...
const Transactions = () => {
  ...
  return (
    <div className='h-full m-8 shadow-lg rounded-lg shadow-lg m-12'>
     ...
     {transactionsData.map((data)=>{
        return(
          <div className='flex w-full m-4'>
            <div className='w-1/6 h-18 border-2 border-green-200 py-12 my-2 rounded-l-md border-l-4 border-teal-900'>
