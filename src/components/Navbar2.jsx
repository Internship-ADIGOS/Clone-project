...
const Navbar2 = () => {
  ...
  return (
    <div className='nav h-12 flex items-center'>
      ...
      <button className="block md:hidden rounded m-1 hover:bg-gray-200 cursor-pointer"
        onClick={handleShow}
      >
      ...
      {show && <div className='md:hidden flex w-full absolute top-10 left- bg-white'>
      ...
      <div className='items hidden md:flex items-center justify-between space-x-4'>
